...
const znbdevicesSchema = new Schema({
  ...
  collection: 'znbdevices'
});

znbdevicesSchema.plugin(uniqueValidator, { message: 'the {PATH} must be unique' });

module.exports = mongoose.model('Znbdevices', znbdevicesSchema);